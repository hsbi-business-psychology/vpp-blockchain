...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-[#000] text-[#d9d9d9]">
      ...
      <div className="mx-auto flex max-w-[1100px] flex-wrap items-center justify-between gap-4 border-t border-[#333] px-4 py-5 md:px-6">
        ...
        <nav className="flex flex-wrap gap-4" aria-label="Legal">
          {legalLinks.map(({ href, label }) => (
            <button
              ...
              className="text-base font-medium text-[#d9d9d9] underline-offset-2 hover:text-white hover:underline"
            >
              {label}
            </button>
          ))}
